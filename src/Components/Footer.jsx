export default function Footer() {
    return (
      <footer className="mt-12 bg-white p-6 text-center border-t border-gray-300 dark:border-gray-700 flex gap-2 items-center  flex-col md:flex-row justify-center ">
